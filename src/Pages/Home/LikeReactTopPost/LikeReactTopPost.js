...
const LikeReactTopPost = () => {

    const { data: posts = [], refetch } = useQuery({
        queryKey: ['like'],
        queryFn: async () => {
            const res = await fetch(`https://social-server-sandy.vercel.app/topThreeLikePosts`, {
                headers: {
                                    ...
                                    <>
                                        {
                                            love === false ?
                                                ...
                                                <div className='flex'>
                                                    <p className='my-auto text-sm'>{post?.love?.n}</p>
                                                    <button disabled className='text-3xl ml-2 mr-5' onClick={() => handleLoveReactAdd(post?._id)}> <FcLikePlaceholder ></FcLikePlaceholder></button>
                                                </div>
                                        }
                                    </>
                                    :
                                    <>
                                        {
                                            love === false ?
                                                ...
                                                <div className='flex'>
                                                    <p className='my-auto text-sm'>{post?.love?.n}</p>
                                                    <button className='text-3xl ml-2 mr-5' onClick={() => handleLoveReactAdd(post?._id)}> <FcLikePlaceholder ></FcLikePlaceholder></button>
                                                </div>
                                        }
                                    </>
                            }
                                    ...
                                    <>
                                        {
                                            like === false ?
                                                ...
                                                <>
                                                    <p className='my-auto text-sm mr-3'>{post?.like?.n}</p>
                                                    <button disabled className='text-3xl' ><FaRegThumbsUp></FaRegThumbsUp></button>
                                                </>
                                    ...
                                    <>
                                        {
                                            like === false ?
                                                ...
                                                <>
                                                    <p className='my-auto text-sm mr-3'>{post?.like?.n}</p>
                                                    <button className='text-3xl' onClick={() => handleLikeReactAdd(post?._id)}><FaRegThumbsUp ></FaRegThumbsUp></button>
                                                </>
                                        }
                                    </>
                            }
...
export default LikeReactTopPost;